...
class heroku:
    def __init__(self, jsonFile, results_folder):
        ...
        self.dict_all = {}
        meta_keys = [u'rt', u'trial_type', u'browser_user_agent', u'browser_major_version', u'stimulus', u'time_elapsed', u'browser_name',
                     u'image_id', u'internal_node_id', u'key_press', u'browser_full_version', u'browser_app_name', u'trial_index', 'worker_code']
        data_keys = [u'rt', u'trial_type', u'slider_start', u'stimulus', u'time_elapsed',
                     u'internal_node_id', 'worker_code', u'response', u'trial_index']
    ...
    def makeCSV(self):
        ...
        self.heroku_data.to_csv(
            self.results_folder + 'filtered_responses/' + heroku_name + '_responses.csv')
